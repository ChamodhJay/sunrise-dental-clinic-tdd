...
<main class="page">
  <div class="page-heading no-print"><h1>Calculate and print patient bill</h1><p>A bill requires a completed appointment and recorded treatment.</p></div>
  ...
  <c:if test="${empty bill}">
    <form class="card no-print" action="${pageContext.request.contextPath}/billing" method="post">
      <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
      <div class="field">
        <label for="appointmentNumber">Appointment number</label>
        <input id="appointmentNumber" name="appointmentNumber" type="text" maxlength="30"
  ...
  <c:if test="${not empty bill}">
    <section class="card" aria-label="Patient bill">
      ...
      <p>Payment terms: Due upon receipt. Thank you for choosing Sunrise Dental Clinic.</p>

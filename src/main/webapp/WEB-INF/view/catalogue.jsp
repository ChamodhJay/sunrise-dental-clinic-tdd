...
<main class="page">
  <div class="page-topbar">
    <div class="breadcrumb">
      ...
      <span class="bc-current">Treatment Catalogue and Fees</span>
    </div>
  </div>
  ...
  <div class="page-body">
    <div class="page-heading">
      ...
      <h1>Treatment catalogue and fees</h1>
      <p>Historical appointments retain their treatment and fee references.</p>
    </div>
    ...
    <section class="card">
      ...
      <form class="grid" action="${pageContext.request.contextPath}/catalogue" method="post">
        ...
        <div class="field span-8">
          <label for="consultationFee">New consultation fee (Rs.)</label>
          <input id="consultationFee" name="consultationFee" type="number" min="0" step="0.01" required>
        </div>
        <div class="field span-4">
          <label>&nbsp;</label>
          <button class="button" type="submit" style="width:100%">Activate new fee</button>
        </div>
      </form>
    </section>
    ...
    <section class="card">
      ...
      <p class="card-subtitle">Add a new treatment to the catalogue</p>
      <form class="grid" action="${pageContext.request.contextPath}/catalogue" method="post">
        ...
        <div class="field span-6"><label for="newPrice">Base price (Rs.)</label><input id="newPrice" name="price" type="number" min="0" step="0.01" required></div>
    ...
    <section class="card">
      <div class="table-toolbar">
        <div class="table-toolbar-left">
          ...
          <p class="card-subtitle">Manage existing catalogue entries</p>
        </div>
      </div>
      <div class="actions-grid">
        <c:forEach var="treatment" items="${treatments}">
          <form class="card" action="${pageContext.request.contextPath}/catalogue" method="post" style="box-shadow:none">
            ...
            <button class="button secondary" type="submit" style="width:100%">Save treatment</button>
          </form>
        </c:forEach>
      </div>
    </section>
